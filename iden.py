...
class BloksIdentityEngine:
    def __init__(self):
        ...
        self.devices = [
            ...
            # --- SAMSUNG (2024-2025) ---
            ("Samsung", "SM-S921B", "{density=3.0,width=1080,height=2340}"),   # S24
            ("Samsung", "SM-S926B", "{density=3.5,width=1440,height=3120}"),   # S24+
            ("Samsung", "SM-A556B", "{density=2.625,width=1080,height=2340}"), # A55 5G
            ("Samsung", "SM-M346B", "{density=2.25,width=1080,height=2340}"),  # M34 5G

            # --- XIAOMI / REDMI (2024-2025) ---
            ...
            # --- OPPO (2024-2025) ---
            ("Oppo", "CPH2631", "{density=3.0,width=1264,height=2780}"),   # Find X8 Pro
            ("Oppo", "CPH2641", "{density=2.0,width=1080,height=2412}"),   # Reno 12 FS
            ("Oppo", "CPH2655", "{density=2.75,width=1080,height=2412}"),  # Reno 13 Pro
            ("Oppo", "CPH2581", "{density=2.25,width=1080,height=2400}"),  # A60

            # --- VIVO (2024-2025) ---
            ("vivo", "V2318", "{density=3.0,width=1260,height=2800}"),     # V40
            ("vivo", "V2405", "{density=3.0,width=1260,height=2800}"),     # X200 Pro
            ("vivo", "V2320", "{density=2.25,width=1080,height=2388}"),    # Y300 Pro

            # --- INFINIX (2024-2025) ---
            ("Infinix", "Infinix X6851", "{density=2.75,width=1080,height=2460}"), # Hot 40 Pro
            ("Infinix", "Infinix X6852", "{density=2.75,width=1080,height=2436}"), # Note 40 Pro+
            ("Infinix", "Infinix X6855", "{density=2.75,width=1080,height=2436}"), # GT 20 Pro

            # --- TECNO (2024-2025) ---
            ("Tecno", "KJ6", "{density=2.75,width=1080,height=2460}"),      # Spark 20 Pro 5G
            ("Tecno", "CL9", "{density=3.0,width=1264,height=2780}"),      # Camon 30 Premier 5G
            ("Tecno", "LI9", "{density=2.75,width=1080,height=2436}"),      # Pova 6 Pro 5G
            ("Tecno", "BG7n", "{density=1.5,width=720,height=1612}"),      # Spark Go 2024
            
            # --- GOOGLE PIXEL (Seri 6 - 9) ---
        ...
        # List Versi Android (OS) - Variasi poin no 2
        self.android_versions = ["10", "11", "12", "13", "14", "15"]
        
        # List Tipe Jaringan - Variasi poin no 3
        ...
        # FBSV mengikuti self.android_version
